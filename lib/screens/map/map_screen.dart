...
class _MapScreenState extends State<MapScreen> {
  ...
  final List<TravelLocation> travelLocations = [
    TravelLocation(
      ...
      longitude: 80.7597,
      description:
          'Ancient rock fortress and UNESCO World Heritage Site with stunning frescoes and panoramic views over the jungle.',
      category: 'Historical',
    ...
    TravelLocation(
      ...
      longitude: 80.6314,
      description:
          'Sacred Buddhist temple in Kandy housing the relic of the tooth of the Buddha. A major pilgrimage site.',
      category: 'Religious',
      shortName: 'Temple of Tooth',
    ),
    TravelLocation(
      id: '3',
      name: 'Mirissa Beach',
      ...
      longitude: 80.4730,
      description:
          'Popular beach town on the southern coast, famous for whale watching and stunning sunsets.',
      category: 'Beach',
      shortName: 'Mirissa',
    ),
    TravelLocation(
      ...
      longitude: 81.0486,
      description:
          'Scenic hiking destination in the hill country with panoramic views over tea plantations and valleys.',
      category: 'Nature',
      shortName: 'Ella Rock',
    ),
    TravelLocation(
      ...
      longitude: 80.2168,
      description:
          'Historic coastal fort built by the Portuguese in the 16th century with charming colonial architecture.',
      category: 'Historical',
    ...
    TravelLocation(
      ...
      longitude: 80.8009,
      description:
          'Sacred mountain with a pilgrimage trail to Sri Pada. A site of worship for Buddhists, Hindus, Muslims and Christians.',
      category: 'Religious',
    ...
    TravelLocation(
      ...
      longitude: 80.7850,
      description:
          'Charming hill station in the central highlands known for its cool climate, tea estates and colonial buildings.',
    ...
    TravelLocation(
      ...
      longitude: 79.8612,
      description:
          'The vibrant capital city blending colonial heritage with modern attractions, markets and waterfront promenades.',
      category: 'City',
      shortName: 'Colombo',
    ),
  ];
  ...
  Future<void> _fetchDirections({
    ...
    try {
      ...
      final summary =
          '${leg['distance']['text']} · ${leg['duration']['text']} via ${route['summary']}';
              ...
              children: [
                ...
                Row(
                  children: [
                    _modeChip(
                      label: '📍 My Location',
                      selected: _originMode == 'gps',
                      onTap: () => setModalState(() => _originMode = 'gps'),
                    ),
                    const SizedBox(width: 8),
                    _modeChip(
                      label: '🗺 Choose Place',
                      selected: _originMode == 'location',
                      onTap: () =>
                          setModalState(() => _originMode = 'location'),
                    ),
                  ],
                ),
                      ...
                      children: travelLocations
                          ...
                          .map((loc) {
                            ...
                            return GestureDetector(
                              onTap: () =>
                                  setModalState(() => _originLocation = loc),
                              child: Container(
                    ...
                    onPressed: () {
                      ...
                      if (kIsWeb) {
                        _openExternalDirections(
                          destination,
                          _originMode == 'location' ? _originLocation : null,
                        );
                      } else {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Expanded(flex: _showNavigationPanel ? 3 : 2, child: _buildMap()),
                ...
                onPressed: _currentStepIndex > 0
                    ? () {
                        ...
                        mapController?.animateCamera(
                          CameraUpdate.newCameraPosition(
                            CameraPosition(
                              target: _navigationSteps[_currentStepIndex]
                                  .startLocation,
                              zoom: 16,
                            ),
                          ),
