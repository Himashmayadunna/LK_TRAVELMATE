    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(
          child: Stack(
            children: [
              const _FloatingAccent(top: 32, left: -28, size: 130),
              const _FloatingAccent(top: 160, right: -16, size: 100),
              CustomScrollView(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Set up your profile to save places, unlock travel ideas, and get a personalized experience across the app.',
            ...
            Row(
              children: const [
                _HeroStat(label: 'Save', value: 'Trips'),
                SizedBox(width: 10),
                _HeroStat(label: 'Trending', value: 'Places'),
                SizedBox(width: 10),
                _HeroStat(label: 'Smart', value: 'Tips'),
              ],
            ),
          ],
        ),
